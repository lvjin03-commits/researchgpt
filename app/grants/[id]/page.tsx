...
import { isGrantAiEditSessionEnabled, isGrantAiPatchEnabled, isGrantAssistantChatEnabled, isGrantCandidateExplanationEnabled, isGrantDocxExportEnabled, isGrantEvidencePatchEnabled, isGrantLocalEvidenceEnabled, isGrantRecheckEnabled, isGrantWorkspaceEnabled } from "@/lib/grants/server/config";
...
export default async function GrantEditorPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  return <GrantStructuredEditor
    ...
    candidateExplanationEnabled={isGrantCandidateExplanationEnabled()}
