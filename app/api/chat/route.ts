...
function artifactTemplateInstruction(
  ...
  return [
    ...
    "- Use only references present in the available source context; if sources are unavailable, state that references need to be completed from source literature instead of fabricating citations.",
