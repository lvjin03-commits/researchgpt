...
function artifactTemplateInstruction(
  ...
  return [
    ...
    "- Do not output JSON, fenced visual blocks, chart specs, or internal tool data inside the manuscript body.",
    "- If a visual is needed, write a normal figure placeholder, caption, and source statement in prose.",
...
function artifactFormatInstruction(
  ...
  if (format === "docx" || format === "pdf" || format === "md") {
    return [
      ...
      "Do not output JSON, fenced visual/chart blocks, Mermaid, or internal figure specifications inside Word/PDF/Markdown source.",
      "When a figure is useful, write only a normal figure placeholder, caption, and source statement in prose.",
  ...
  return [
    {
      ...
      content: [
        ...
        "Keep final document text separate from internal tool data. Never place JSON tool payloads inside Word/PDF/Markdown body content.",
