...
export function buildGrantSemanticDiagnosticV3Messages(
  ...
  const system = [
    ...
    "Do not predict funding outcomes, assign severity, rewrite the application, invent facts, references, data, authors, IDs or missing content.",
    ...
    "Use only supplied sectionId, nodeId and cardId values. The program owns all durable IDs and ordering.",
