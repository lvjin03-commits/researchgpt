...
export const GrantModelCallAttemptSchema = z.object({
  ...
  operation: z.enum([GRANT_EDIT_SESSION_TURN_OPERATION, GRANT_ASSISTANT_CHAT_OPERATION, GRANT_WEB_QUERY_REWRITE_OPERATION, GRANT_WEB_SOURCE_ASSESS_OPERATION, GRANT_WEB_ANSWER_SYNTHESIZE_OPERATION, LEGACY_GRANT_EDIT_CANDIDATE_EXPLAIN_OPERATION]),
  policyVersion: z.enum([GRANT_EDIT_SESSION_TURN_POLICY_VERSION, GRANT_ASSISTANT_CHAT_POLICY_VERSION, GRANT_WEB_QUERY_REWRITE_POLICY_VERSION, GRANT_WEB_SOURCE_ASSESS_POLICY_VERSION, GRANT_WEB_ANSWER_SYNTHESIZE_POLICY_VERSION, LEGACY_GRANT_EDIT_CANDIDATE_EXPLAIN_POLICY_VERSION]),
